<%@ Page Language="C#" Title="注册外部登录" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="VFX.Account.RegisterExternalLogin" %>
